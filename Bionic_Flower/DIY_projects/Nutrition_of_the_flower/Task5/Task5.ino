/*Nutrition, Task 5 : The bionic flower open if the luminosity is enough (day), otherwise the flower is closing (night).
In addition, when it's the day, the degree of opening of the flower depends on the quantity of the water (moisture soil sensor)*/
...
void setup() 
{
 ...
 Serial.begin(9600);
 Serial.println("Nutrition of the flower scenario : Task 5");
...
{  
    ...
    // The flower open if the degree of opening is not the limit_open value
    if (current_position< limit_open)      
    { 
      stepper.rotate(360);
