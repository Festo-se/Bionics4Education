/*PHTOTOSYNTHESIS, Task 5 : Using of the CO2 sensor . */
...
void setup() 
{
 ...
 Serial.begin(9600);
 Serial.println("Photosynthesis : Task 5 ");
...
{  
    ...
    if (CO2_value > limit_CO2)
    {
      Serial.println("Breath deteced");
    }
    else 
    {
      Serial.println("No breath deteced");
    }
