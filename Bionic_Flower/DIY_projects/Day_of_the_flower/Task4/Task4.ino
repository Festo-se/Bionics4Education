/*DAY OF THE FLOWER, Task 4 : Using of the temperature sensor. */
...
void setup() 
{
 ...
 Serial.begin(9600);
 Serial.println("Day of the flower : Task 4");
...
{ 
 ...
 Serial.println("Degree of opening");
 Serial.println(degree_opening);
