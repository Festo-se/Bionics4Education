/*Diversity of the flower , Task 4 : A  color is detected, the flower lights like this color and open (50%).
If a breath is detected, the flower closes.*/
...
void setup() 
{
 ...
 Serial.begin(9600);
 Serial.println("Diversity of the flower scenario : Task 4");
