/*Diversity of the flower , Task 3 : If a color is detected, the flower lights up in 
the color which has been detected and the bionics flower opens */
...
void setup() 
{
 ...
 Serial.begin(9600);
 Serial.println("Diversity of the flower scenario : Task 3");
