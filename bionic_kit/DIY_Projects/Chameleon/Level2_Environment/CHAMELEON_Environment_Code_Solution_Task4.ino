...
//SETUP: function that initialize the components and display a start message to the serial monitor
 ...
 //ESP32 receives information from the touch sensor
  ...
  Serial.begin(9600);
  delay(5000);
  Serial.println(" Environment : task 4 !"); 

}

//LOOP: function that read and display the touch sensor's value. Then, the function read and display the light value, if it is the day the red LED is on and the tongue moves, if not the blue LED create a snoring - code executed repeatedly
void loop()
{ 
