...
//SETUP: function that initialize the components and display a start message to the serial monitor
 void setup()
 {
  ...
  Serial.begin(9600);
  delay(5000);
  Serial.println("Swimming competition: task 4!");  


}

//LOOP: function that calculates the points for the touch sensor,the light sensor and the color sensor. Then,the function display for each player, their number and calculates their score. You can restart the game.
void loop()
{
  while (Restart==true)
  { 
