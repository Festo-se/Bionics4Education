...
# STEP-BY-STEP 
# Cycle of the day 
![Fish](/Scenario/Image/Cycle_of_the_day_photo_finale.JPG)
...
![Fish](/Scenario/Image/Cycle_of_the_day_components.JPG)
...
![Cycle of the day step 1 ](/Scenario/Image/Cycle_of_the_day_Task1.PNG) <br>(C) This image was created with Fritzing.
...
![Cycle of the day step 2 ](/Scenario/Image/Cycle_of_the_day_Task2.PNG) <br>(C) This image was created with Fritzing.
...
<img src="/Scenario/Image/Warning_sghr.PNG" alt="warning" width="50"/> *Don't forget the 4.7km Ohm resistor.*
## Code: 
1. *global variables* 
...
<br><img src="/Scenario/Image/bulb_sghr.PNG" alt="bulb" width="50"/>*You can take the sensor on you hands to increase the temperature.*
2. *setup()* 
<br>Please indicate the mode of the temperature sensor.
<br><img src="/Scenario/Image/Warning_sghr.PNG" alt="warning" width="50"/> *The ESP32 receives information from the temperature sensor*
3. *loop()*
...
![Cycle of the day step 3](/Scenario/Image/Cycle_of_the_day_Task3.PNG) <br>(C) This image was created with Fritzing.
...
<br><img src="/Scenario/Image/bulb_sghr.PNG" alt="bulb" width="50"/>*Don't hesitate to consult the documentation to know wich function you can use to control the servomotor.*
...
![Cycle of the day step 4](/Scenario/Image/Cycle_of_the_day_Task4.PNG) <br>(C) This image was created with Fritzing.
...
<br>![Cycle of the day step 4](/Scenario/Image/Cycle_of_the_day_structure.JPG)
...
3. *loop()* 
<br><img src="/Scenario/Image/bulb_sghr.PNG" alt="bulb" width="50"/>*Please comment the next code to understand how a servomotor works.* 
...
<br><img src="/Scenario/Image/bulb_sghr.PNG" alt="bulb" width="50"/>*You can modify the swimming amplitude by changing the degree set points and modify the swimming speed by changing the delay (Temporization value), make tests to understand how it works!* 
...
<br>3. *loop()* 
<br><img src="/Scenario/Image/Warning_sghr.PNG" alt="warning" width="50"/> *Remember to uncomment the task 3 code.*
...
<br> <br><img src="/Scenario/Image/firework_sghr.png" alt="fireworh" width="50"/> Congratulations, you've coded the **Cycle of the day** scenario successfully!