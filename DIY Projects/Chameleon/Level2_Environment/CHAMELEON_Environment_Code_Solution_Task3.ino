...
void setup()
 ...
 //Initial position
  ...
  Serial.begin(9600);
  delay(5000);
  Serial.println("Environment: task 3!"); 
}

//LOOP - function that read and display the light value, if it is the day the red LED is on and the tongue moves, if not the blue LED create a snoring - code executed repeatedly
void loop()
{ 
