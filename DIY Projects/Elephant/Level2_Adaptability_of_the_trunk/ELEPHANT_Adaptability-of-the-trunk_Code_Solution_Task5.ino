...
void setup()
{
  ...
  ledcAttachPin(PIN_SERVO,LED_Channel0);
  ledcSetup(LED_Channel0,Frequence0,Resolution0);
  
  //SERIAL COMMUNICATION
  Serial.begin(9600); 
  delay(5000);
  Serial.println("Adapatability of the trunk: task 5! "); 
}

//LOOP: function that read the light value. If it is daytime, the elephant communicates with you: every time you press the sensor to touch a sound is created. If it is the middle of the day, the elephant trunk moves. If it is night, the led creates a snoring. - code executed repeatedly
void loop()
{  
